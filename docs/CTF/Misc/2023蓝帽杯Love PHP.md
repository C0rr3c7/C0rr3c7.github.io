...
然后在绕过`wakeup`函数，最后就是绕过`file`函数

因为php版本是7.4.33，所以不能改变属性数来绕过wakeup函数

但可以进行C绕过，就是将O改成C

但这样的话只能执行construct()函数或者destruct()函数，无法添加任何内容`C:8:"Saferman":0:{}`

然后就是利用filterchain进行攻击
...
[Webの侧信道初步认识](https://boogipop.com/2023/05/08/Web%E4%BE%A7%E4%BF%A1%E9%81%93%E5%88%9D%E6%AD%A5%E8%AE%A4%E8%AF%86/#DownUnderCTF2022-minimal-php)

[php中wakeup函数绕过](https://fushuling.com/index.php/2023/03/11/php%E5%8F%8D%E5%BA%8F%E5%88%97%E5%8C%96%E4%B8%ADwakeup%E7%BB%95%E8%BF%87%E6%80%BB%E7%BB%93/)